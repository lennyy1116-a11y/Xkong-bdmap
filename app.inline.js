...
const LEAD_CATEGORY_TAXONOMY = {
  ...
  '中医与传统医学': ['中医综合诊所','中医骨伤／正骨诊所','传统疗法／养生馆'],
  '康复与辅助医疗': ['物理治疗中心','职业治疗中心','言语治疗中心','脊医诊所','听力／听觉服务中心','足病诊疗／足部康复中心','综合复康中心'],
  '护理养老与社区照护': ['家居照顾及支援队','长者日间护理中心','社区复康日间中心','安老院／护养院／护理院','认知障碍／记忆照护中心','残疾人士日间训练／支援中心'],
  '心理与身心健康': ['精神科诊所','临床心理服务中心','心理辅导／咨询中心','儿童发展／评估中心','社区精神健康／复元中心','成瘾治疗／辅导中心'],
  '营养健康与药品零售': ['注册营养师／营养咨询中心','体重管理／健康管理中心','保健品／营养补充品零售'],
  '运动健身': ['健身房／健身中心','瑜伽馆'],
  '健康餐饮': ['轻食／健康餐厅','养生茶饮／草本饮品店','药膳／中式养生餐厅'],
...
const LEAD_SECONDARY_NAME_TO_CODE = Object.fromEntries(Object.entries({
  ...
  TCM:['TCM-01','TCM-02','TCM-06'], AHP:['AHP-01','AHP-02','AHP-03','AHP-04','AHP-05','AHP-06','AHP-08'],
  CARE:['CARE-02','CARE-03','CARE-04','CARE-05','CARE-07','CARE-08'], MHW:['MHW-01','MHW-02','MHW-03','MHW-04','MHW-05','MHW-06'],
  NUT:['NUT-01','NUT-02','NUT-04'], FIT:['FIT-01','FIT-03'], FNB:['FNB-01','FNB-02','FNB-03'],
